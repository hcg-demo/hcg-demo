...
KB_CONFIGS = {
    'hr': {'name': 'HCG-Demo-HR-KB', 'desc': 'HR policies', 'folder': 'Sample Data/hr', 's3_prefix': 'hr-docs/'},
    'it': {'name': 'HCG-Demo-IT-KB', 'desc': 'IT support', 'folder': 'Sample Data/it', 's3_prefix': 'it-docs/'},
    'finance': {'name': 'HCG-Demo-Finance-KB', 'desc': 'Finance', 'folder': 'Sample Data/finance', 's3_prefix': 'finance-docs/'},
    'general': {'name': 'HCG-Demo-General-KB', 'desc': 'General', 'folder': 'Sample Data/general', 's3_prefix': 'general-docs/'}
}
