...
KB_CONFIGS = {
    'hr': {'name': 'HCG-Demo-HR-KB', 'desc': 'HR policies', 'folder': 'Sample Data/hr', 's3_prefix': 'hr-docs/', 'index': 'bedrock-knowledge-base-default-index'},
    'it': {'name': 'HCG-Demo-IT-KB', 'desc': 'IT support', 'folder': 'Sample Data/it', 's3_prefix': 'it-docs/', 'index': 'bedrock-knowledge-base-default-index'},
    'finance': {'name': 'HCG-Demo-Finance-KB', 'desc': 'Finance policies', 'folder': 'Sample Data/finance', 's3_prefix': 'finance-docs/', 'index': 'bedrock-knowledge-base-default-index'},
    'general': {'name': 'HCG-Demo-General-KB', 'desc': 'Company info', 'folder': 'Sample Data/general', 's3_prefix': 'general-docs/', 'index': 'bedrock-knowledge-base-default-index'}
}
