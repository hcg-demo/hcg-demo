...
deploy_lambda('hcg-demo-servicenow-action', 'src/lambda_servicenow_simple.py', 'lambda_function.py')

print("\n5. Run to ensure concurrency & timeout: python scripts/infra/ensure_webhook_concurrency.py")
